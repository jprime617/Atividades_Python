...
# tupla_vendas = ("lira", "25/08/2022","15/02/1994",2000,"Estagiario")
# nome, data_contratacao, data_nascimento, salario, cargo = tupla_vendas
...
#     print(i, item, funcionarios[i])

# print("###############")

# for i in range(len(vendas)):
#     print(i ,vendas[i], funcionarios[i])
